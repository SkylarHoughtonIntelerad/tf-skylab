...
module "testgroup-patchgroup" {
  source      = "git::ssh://git@github.com/dicomgrid/pt-modules.git//aws/ssm-patch-group?ref=v4.13.2"
...
module "testgroup-resourcegroup" {
  source         = "git::ssh://git@github.com/dicomgrid/pt-modules.git//aws/resource-group?ref=v4.13.2"
