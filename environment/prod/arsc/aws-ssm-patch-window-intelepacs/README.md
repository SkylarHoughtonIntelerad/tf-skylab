...
| <a name="module_mdb2-patchgroup"></a> [mdb2-patchgroup](#module\_mdb2-patchgroup) | git::ssh://git@github.com/dicomgrid/pt-modules.git//aws/ssm-patch-group | master |
| <a name="module_mdb2-resourcegroup"></a> [mdb2-resourcegroup](#module\_mdb2-resourcegroup) | git::ssh://git@github.com/dicomgrid/pt-modules.git//aws/resource-group | master |
| <a name="module_mdb2-start-pacs"></a> [mdb2-start-pacs](#module\_mdb2-start-pacs) | git::ssh://git@github.com/dicomgrid/pt-modules.git//aws/ssm-shell-task | master |
| <a name="module_mdb2-target"></a> [mdb2-target](#module\_mdb2-target) | git::ssh://git@github.com/dicomgrid/pt-modules.git//aws/ssm-target | master |
| <a name="module_mdb2-window"></a> [mdb2-window](#module\_mdb2-window) | git::ssh://git@github.com/dicomgrid/pt-modules.git//aws/ssm-maintenance-window | master |
...
|------|-------------|------|---------|:--------:|
| <a name="input_group1_tags"></a> [group1\_tags](#input\_group1\_tags) | Resource Group Tags | `map(string)` | <pre>{<br>  "Customer": "arsc",<br>  "Patch Group": "group1",<br>  "Product": "intelepacs"<br>}</pre> | no |
| <a name="input_group2_tags"></a> [group2\_tags](#input\_group2\_tags) | Resource Group Tags | `map(string)` | <pre>{<br>  "Customer": "arsc",<br>  "Patch Group": "group2",<br>  "Product": "intelepacs"<br>}</pre> | no |
| <a name="input_mdb1_tags"></a> [mdb1\_tags](#input\_mdb1\_tags) | Resource Group Tags | `map(string)` | <pre>{<br>  "Application": "mdb",<br>  "Customer": "arsc",<br>  "Patch Group": "mdb1",<br>  "Product": "intelepacs"<br>}</pre> | no |
| <a name="input_mdb2_tags"></a> [mdb2\_tags](#input\_mdb2\_tags) | Resource Group Tags | `map(string)` | <pre>{<br>  "Application": "mdb",<br>  "Customer": "arsc",<br>  "Patch Group": "mdb2",<br>  "Product": "intelepacs"<br>}</pre> | no |
...
| <a name="input_testgroup_tags"></a> [testgroup\_tags](#input\_testgroup\_tags) | Resource Group Tags | `map(string)` | <pre>{<br>  "Customer": "arsc",<br>  "Patch Group": "test",<br>  "Product": "intelepacs"<br>}</pre> | no |
